    ...
    render() {
        return (
            <div className="container-fluid" style={{ backgroundColor: this.props.bgColor }}>
                <div className="card d-flex align-items-center w-100 p-4">
                    <div className="row flex-grow-1">
                        <div className="col text-center align-self-center">
                            <div className="row">
                                <div className="col text-center">
                                    <p id="text" className="text-center fs-5 transition-color" style={{ color: this.props.bgColor }}>
                            ...
                            <div className="row">
                                <div className="col text-center">
                                    <p id="author" className="text-center fs-6 fw-light transition-color" style={{ color: this.props.bgColor }}>
